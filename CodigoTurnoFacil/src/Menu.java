...
public class Menu {
	...
	public static void sacarTurno (Clinica c1, Paciente p, Scanner sn) {
		...
		if (medicoSelec != null) {
			...
			int mananaOTarde = 2; // Esta variable es para saber si  va a querer horario solo de ma̱ana o de tarde o da igual
			try {
				while (mananaOTarde > 1 || mananaOTarde <  -1) {
					System.out.println("Ingresa 1 para turnos de solo ma̱ana, -1 para turno de tarde o 0 si no importa");
